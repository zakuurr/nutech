<div class="col-auto col-sm-2 col-md-3 col-xl-2 p-0 bg-danger min-vh-100">
    <div class="d-flex flex-column">
      ...
      <a href="{{ route('product.index') }}" class="text-decoration-none text-white mb-2 px-3 py-1" id="product">
        <img src="{{ asset('') }}assets/img/Package.png" alt="Package.png" class="me-2" width="20" height="20">
        Produk
      </a>
      <a href="/profil" class="text-decoration-none text-white mb-2 px-3 py-1" id="profile" width="20" height="20">
